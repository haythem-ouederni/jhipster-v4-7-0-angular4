package com.jhipsterangular.test.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterAngular4");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterAngular4");
        ...
        config.getMapConfigs().put("com.jhipsterangular.test.domain.*", initializeDomainMapConfig(jHipsterProperties));
